package org.framework.integration.example.web.mvc.service.impl;
...
import org.framework.integration.example.web.mvc.service.TransactionTestService;
...
public class DefaultTransactionTestService extends ServiceImpl<UserMapper, User> implements TransactionTestService {
    ...
    @Override
    @Transactional
    public void tryCatchFinallyTest(User user) {
        ...
        try {
            ...
            var catchUser = new User().setName("catch" + UUID.randomUUID());
            save(catchUser);
